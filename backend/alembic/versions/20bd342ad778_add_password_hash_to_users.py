...
Revision ID: 20bd342ad778
Revises: 
Create Date: 2025-07-18 16:53:27.023031
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('queued', 'running', 'done', 'error', 'cancelled', name='jobstatus'), nullable=False),
    ...
    op.create_index(op.f('ix_server_credentials_id'), 'server_credentials', ['id'], unique=False)
